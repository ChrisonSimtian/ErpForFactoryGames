...
| [0029](0029-standalone-game-libraries-as-nuget-packages.md) | Per-game libraries as standalone repos publishing `ErpForFactoryGames.*` packages | Accepted (amends [0014](0014-pure-csharp-save-ingestion-via-fork.md), [0021](0021-migrate-from-nuke-fork-to-fallout.md)) |
